...
<head>
    ...
    <title>Login Burned Coffee</title>
    <style>
        .banner {
...
<body>
    <div class="row">
        ...
        <div class="col-4 d-flex justify-content-end">
            <div>
                <a href="novo.php" class="btn btn-light" style="background-color: #97a5cd;">Criar Conta</a>
            </div>
        </div>
    </div>
    <div class="card w-75 mt-3 mx-auto" style="background: transparent; border: none;">
        ...
        <form>
            ...
            <!--<a href="home.php" class="button btn btn-outline-primary btn-lg" type="submit">Entrar</a>-->
                <input type="submit" class="button btn btn-outline-primary btn-lg" value="Entrar">
            </div>
            ...
            <div class="d-flex justify-content-center">
            <a class="google btn btn-primary btn-lg mt-3" href="https://accounts.google.com/v3/signin/identifier?authuser=0&continue=https%3A%2F%2Fwww.google.com%2F&ec=GAlAmgQ&hl=pt-BR&flowName=GlifWebSignIn&flowEntry=AddSession&dsh=S-1122230894%3A1739046099473430&ddm=1">Entrar com Google</a>
            </div>
        </form>
        </div>
    </div>
