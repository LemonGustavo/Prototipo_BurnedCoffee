                        ...
                        <div class="col-5 d-flex">
                            <div class="card" style="background-color: #1F3A93;">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6"></div>
                                        <div class="col-6"><img style="width: 150px;" src="../img/estrela.png"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <a href="exer1errado.php" style="text-decoration: none;">
                            ...
                            <a href="exer1certo.php" style="text-decoration: none;">
                            <div class="card mb-2" style="text-align: center; margin: none; background-color: #1F3A93; color: white; font-size: 24px;">
                                <div class="card-body">
