...
if (!empty($_GET)) {
    ...
    $email = $_GET['cpEmail'];
    $senha = $_GET['cpSenha'];
    $msg = cadastrar_usuario($nome, $email, $senha);
...
<head>
    ...
    <title>Criar Conta Burned Coffee</title>
    <style>
        .banner {
        ...
        footer {
            ...
            padding: 10px 0;
            position: fixed;
            bottom: 0; /* Esconde o footer inicialmente */
            left: 0;
            width: 100%;
...
<body>
    <div class="row">
        <div class="col-4 d-flex justify-content-start">
            <div>
                <a href="index.php" class="btn btn-light" style="background-color: #97a5cd;">Voltar</a>
            </div>
        </div>
        <div class="col-4 d-flex justify-content-center">
            <div class="alert banner text-center" style="width: auto; padding: 10px 20px;">
                BURNED COFFEE
            </div>
        </div>
        <div class="col-4 d-flex justify-content-end">
            <div>
                <a href="login.php" class="btn btn-light" style="background-color: #97a5cd;">Entrar</a>
            </div>
        </div>
    </div>
    <div class="card w-75 mt-3 mx-auto" style="background: transparent; border: none;">
        <div class="card-body">
        <form>
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4">
                    ...
                    <input class="form-control" name="cpNome" placeholder="Nome de Usuário" aria-label="nome" aria-describedby="basic-addon1">
                    </div>
                </div>
                <div class="col-4"></div>
            </div>
            <div class="row">
                ...
                <div class="col-4">
                    <div class="input-group mb-3">
                    <input class="form-control" name="cpEmail" placeholder="E-mail" aria-label="email" aria-describedby="basic-addon1">
                    </div>
                </div>
                <div class="col-4"></div>
            </div>
            <div class="row">
                ...
                <div class="col-4">
                    <div class="input-group mb-3">
                    <input type="password" class="form-control" name="cpSenha" placeholder="Senha" aria-label="senha" aria-describedby="basic-addon1">
                    </div>
                </div>
                <div class="col-4"></div>
            </div>
            <div class="d-flex justify-content-center">
                <input type="submit" class="button btn btn-outline-primary btn-lg" value="Criar">
            </div>
            ...
            <div class="d-flex justify-content-center">
            <a class="google btn btn-primary btn-lg mt-3" href="https://accounts.google.com/v3/signin/identifier?authuser=0&continue=https%3A%2F%2Fwww.google.com%2F&ec=GAlAmgQ&hl=pt-BR&flowName=GlifWebSignIn&flowEntry=AddSession&dsh=S-1122230894%3A1739046099473430&ddm=1">Criar com Google</a>
            </div>
        </form>
        </div>
    </div>
    <footer class="bd-footer mt-4">
        <div class="container">
            Projeto Burned Coffee - 3° A Informática
        </div>
</footer>
</body>
</html>