        ...
        <div class="col-10">
            <div class="card mt-2">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="card" style="background-color: rgb(12, 32, 97); color: white;">
                                <h1>Não desista! &#128170</h1>
                            </div>
                            <div class="row">
                                <div class="col-6 mt-2">
                                <div class="card" style="background-color: white; border: 10px solid #B5298B;">
                                    <div class="card-body">
                                        <h2 style="text-align: center;">01/02</h2>
                                    </div>
                                </div>
                                </div>
                                <div class="col-6 mt-2">
                                <div class="card" style="background-color: white; border: 10px solid green;">
                                    <div class="card-body">
                                        <h2 style="text-align: center;">2 min</h2>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-2"></div>
                                        <div class="col-10 d-flex justify-content-end">
                                        <a href="unidade.php" class="btn btn-light" style="background-color: #97a5cd; width: 100%;">Concluir</a>
                                    </div>
                                </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6"><img src="../img/estrela4.png" style="width: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
