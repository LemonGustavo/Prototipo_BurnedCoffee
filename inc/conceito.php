  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Desistir da leitura fará com que ela não seja salva como completa!
      </div>
      <div class="modal-footer">
        ...
        <a href="unidade.php" class="btn btn-danger" style="background-color: red;">Desistir</a>
                    ...
                    <div class="row">
                        <div class="col-5"><img src="../img/moço.png" style="width: 100%"></div>
                        <div class="col-6">
                            <div class="card" style="margin: none; background-color: white;">
                                <div class="card-body">
                                    <h1>O que é Algoritmo?</h1><br>
                                    <div class="text-justify">Um algoritmo nada mais é que uma sequência de instruções ou comandos realizados de forma sistemática com a finalidade de resolver um problema ou executar uma determinada tarefa. Ou seja, é criado para resolver “problemas”, com instruções bastante simples e exatas. Um algoritmo pode ser representado de várias maneiras, como em pseudocódigo, fluxogramas ou até mesmo em linguagens de programação específicas. Essa representação facilita a compreensão do processo a ser seguido, permitindo que programadores e outros profissionais da área visualizem claramente cada etapa envolvida.</div>
                                    <div class="text-justify mt-1">Além disso, a eficácia de um algoritmo não se mede apenas pela sua capacidade de resolver um problema, mas também pela eficiência com que isso é feito. Um bom algoritmo deve ser capaz de operar em um tempo razoável e consumir uma quantidade adequada de recursos, como memória e processamento.</div>
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <a href="unidade.php" class="btn btn-light" style="background-color: #97a5cd;">Concluir leitura</a>
                        </div>
                    </div>
                </div>
            </div>
