        ...
        <a href="unidade.php" class="btn btn-danger" style="background-color: red;">Desistir</a>
                    ...
                    <div class="row">
                        <div class="col-5 d-flex">
                            <div class="card" style="background-color: #1F3A93;">
                                <div class="card-body">
                                    ...
                                    <h2 style="color: white; text-align: center; font-size: 50px;">O que é um loop "for" em progamação?</h2>
                                    <div class="row">
                                        <div class="col-6"></div>
                                        <div class="col-6"><img style="width: 150px;" src="../img/estrela3.png"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            ...
                            <div class="card mb-2" style="text-align: center; margin: none; background-color: green; color: white; font-size: 24px;">
                                <div class="card-body">
                                    <p>Uma estrutura de repetição</p>
                                </div>
                            </div>
                            <div class="card mb-2" style="text-align: center; margin: none; background-color:  #1F3A93; color: white; font-size: 24px;">
                                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <a href="exer2.php" class="btn btn-light" style="background-color: #97a5cd;">Próxima pergunta</a>
                        </div>
                    </div>
                </div>
            </div>
